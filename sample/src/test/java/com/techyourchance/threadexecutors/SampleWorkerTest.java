...
public class SampleWorkerTest {
    ...
    private ExecutorsTestController mExecutorsTestController = new ExecutorsTestController();
    ...
    public void setup() throws Exception {
        ...
        SUT = new SampleWorker(
                ...
                mExecutorsTestController.getBackgroundThreadExecutorTestDouble(),
                mExecutorsTestController.getUiThreadExecutorTestDouble());
